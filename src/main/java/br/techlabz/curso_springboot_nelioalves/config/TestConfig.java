package br.techlabz.curso_springboot_nelioalves.config;
...
import br.techlabz.curso_springboot_nelioalves.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	private final CursoSpringbootNelioalvesApplication cursoSpringbootNelioalvesApplication;
	...
	public void run(String... args) throws Exception {
		...
		//Salvando as associações com categorias
		...
		Payment pay2 = new Payment(null, Instant.parse("2019-06-22T08:50:00Z"), o1);
		o1.setPayment(pay2);
